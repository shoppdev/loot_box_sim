...
class Weapon:
    ...
    def build_weapon(self):
        ...
        if prcnt > 0 and prcnt <= 0.25:         # .25%
            ...
            self.value = random.randint(0, 1000) + base_values[11]
